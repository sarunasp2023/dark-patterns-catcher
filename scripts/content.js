const detectDarkPatterns = async (sendResponse, highlight, modify) => {
  ...
  const foundCountdownTimerDarkPatternsNumber = await detectCountdownTimerCases(highlight, modify, domCopy);
  const foundPreselectionDarkPatternsNumber = detectPreselectionCases(highlight, modify, domCopy);
  const foundMisdirectionDarkPatternsNumber = detectMisdirectionCases(highlight, modify, domCopy);
  const foundScarcityDarkPatternsNumber = detectScarcityCases(highlight, modify, domCopy);
  const foundDisguisedAdDarkPatternsNumber = detectDisguisedAdCases(highlight, modify, domCopy);
  const foundSocialProofPatternsNumber = detectSocialProofCases(highlight, modify, domCopy);

  const darkPatternsCount = foundCountdownTimerDarkPatternsNumber + foundPreselectionDarkPatternsNumber 
    + foundMisdirectionDarkPatternsNumber + foundScarcityDarkPatternsNumber + foundDisguisedAdDarkPatternsNumber
